...
namespace TaxCalculatorTests
{
    ...
    {
        private readonly ITaxSettings _settings = new DictionaryTaxSettings(
            "{\"8350\":\"0.1\",\"33950\":\"0.15\",\"82250\":\"0.25\",\"171550\":\"0.28\",\"372950\":\"0.33\",\"100000000\":\"0.35\"}");
        ...
        public void TestExtensiveMustPass()
        {
            ...
            Assert.AreEqual(new ProgressiveTaxCalculation().Calculate(8350, _settings), 8350 * 0.1,
                "Calculation error");
            Assert.AreEqual(new ProgressiveTaxCalculation().Calculate(30000, _settings),
                (8350 * 0.1) + ((30000 - 8350) * 0.15), "Calculation error");
            Assert.AreEqual(new ProgressiveTaxCalculation().Calculate(80000, _settings),
                (8350 * 0.1) + ((33950 - 8350) * 0.15) + ((80000 - 33950) * 0.25), "Calculation error");
            Assert.AreEqual(new ProgressiveTaxCalculation().Calculate(500000, _settings),
                (8350 * 0.1) + ((33950 - 8350) * 0.15) + ((82250 - 33950) * 0.25) + ((171550 - 82250) * 0.28) +
                ((372950 - 171550) * 0.33) + ((500000 - 372950) * 0.35), "Calculation error");
        }
