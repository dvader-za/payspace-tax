...
namespace TaxCalculator
{
    ...
    {
        private readonly Dictionary<string, ITaxCalculation> _calculators = new Dictionary<string, ITaxCalculation>();
        private readonly Dictionary<string, ITaxSettings> _settings = new Dictionary<string, ITaxSettings>();
